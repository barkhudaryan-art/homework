...
const EMOJI_REGEX = new RegExp(regex.replace(/\s|\n/g, ''), 'g');
...
console.log( reverse_string( '🧍 🧍‍♂️ 🧍‍♀️ 🧎 🧎‍♂️ 🧎‍♀️' ) );
console.log( reverse_string( '💱 ™️ ©️ ®️ 〰️ 💩 𝐁' ) );
console.log( reverse_string( 'AABB🧎‍' ) );
console.log( reverse_string( 'tree🧔‍♂️q' ) );
console.log( reverse_string( 'ytr𝌆❤️𝌆esd❤️sdg👮🏾‍♀️wq😀' ) );
// console.log( reverse_string( TEXT ) );
